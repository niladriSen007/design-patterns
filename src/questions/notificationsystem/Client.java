...
import questions.notificationsystem.entiity.Recipient;
...
public class Client  {
    static void main() throws InterruptedException {
        ...
        Notification welcomeEmail = new Notification.Builder(recipient1, NotificationType.EMAIL).subject("Welcome!")
                .message("Welcome to notification system").build();
